describe('Merge Sort', function(){
  ...
  xit('handles an empty array', function (){
   ...
   xit('handles an array of 1', function (){
    expect( mergeSort([1])).toEqual([1])
  });
  it('handles an array of odd elements', function (){
    expect( mergeSort([1,9,5,6,3])).toEqual( [1,3,5,6,9])
  })
  xit('handles an array of elements in order', function (){
    expect( mergeSort([1,2,3,4,5])).toEqual( [1,2,3,4,5])
  })
  xit('handles an array of elements', function (){
    expect( mergeSort([9,6,5,3,1,0])).toEqual( [0,1,3,5,6,9])
  })
  xit('handles an array of negative numbers in elements', function (){
